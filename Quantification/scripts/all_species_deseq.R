...
annot <- read.csv("/Users/ferenckagan/annotation.csv")
...
#load('/Users/ferenckagan/Documents/Bioinformatic_analysis/Gene_expr_evolution/Quantification/Intermediate_files/DGE_script_enviorment.RData')
